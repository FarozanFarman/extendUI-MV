	...
	return BaseController.extend("ns.BP.controller.Master", {
		...
		onInit : function () {
			...
			this._oGroupFunctions = {
				CompanyName : function(oContext) {
					var iNumber = oContext.getProperty('CompanyName'),
						key, text;
					if (iNumber <= 20) {
						key = "LE20";
		...
		onConfirmViewSettingsDialog : function (oEvent) {
			...
			aFilterItems.forEach(function (oItem) {
				switch (oItem.getKey()) {
					case "Filter1" :
						aFilters.push(new Filter("CompanyName", FilterOperator.LE, 100));
						break;
					case "Filter2" :
						aFilters.push(new Filter("CompanyName", FilterOperator.GT, 100));
						break;
					default :
						break;
				}
