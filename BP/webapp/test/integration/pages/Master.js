		...
		onTheMasterPage : {
			...
			actions : {
				...
				iFilterTheListOnUnitNumber : function () {
					return this.iMakeASelection("filterButton", "<CompanyName>", "<100 <CompanyName>");
				},

				iGroupTheList : function () {
					return this.iChooseASorter("groupButton", "<CompanyName> Group");
				},
			...
			assertions : {
				...
				theListShouldBeFilteredOnUnitNumber : function () {
					return this.theListShouldBeFilteredOnFieldUsingComparator("CompanyName", 100);
				},
